...
public class FrontControllerServletV1 extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String requestURI = request.getRequestURI(); // /front-controller/v1/members/new-form 이러한 형태의 값을 받는다.

        ControllerV1 controller = controllerMap.get(requestURI); // controllerMap에서 꺼낸다. controllerMap이 Key-Value형태이므로
        if (controller == null) {
